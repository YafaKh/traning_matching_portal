...
<div class="px-5">
    ...
    <form class="input-group mt-5 mb-3 w-auto" role="searprimarych" type="get" action="{{route('trainer_list_traniees.search',['user_id' => $user->id])}}">
        <input class="form-control txt-sm h-50 border border-secondary" id="search" name="search" type="search" placeholder="Search by student name" aria-label="Search">
