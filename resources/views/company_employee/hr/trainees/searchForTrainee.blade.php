...
<div class="px-3 d-flex flex-lg-row flex-column">       
    <div class="col-lg-9 mt-4 pe-3">
        ...
        <div class="d-flex ">
            ...
            <form class="input-group flex-grow-1  mb-2" role="searprimarych" type="get" action="{{route('search.hr_list_trainees',['user_id' => $user->id])}}">
                <input class="form-control txt-sm border  border-secondary-subtle" data-bs-toggle="tooltip" data-bs-placement="top"
                data-bs-title="Search by the trainee's name" type="search" placeholder="Search Name" id="search" name="search">
