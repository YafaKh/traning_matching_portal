...
<div class=" col-md-9 bg-white mb-3 p-md-5 px-3 mx-auto rounded-bottom-2">
  <div class="d-flex flex-row ">
    ...
    <div class="ms-5">
      <p>Company</p>
      <p>{{$student->training->branch->company->name ??''}}</p><hr>
    </div>
  </div>
</div>
...
<form method="POST" action="{{ route('store_visit', ['user_id'=>$user->id, 'student_id'=> $student->id]) }}">
@csrf
...
<div class="d-flex flex-row mt-3">
    <p>Visit Date: </p>
    <input type = "time" name = "time" class="ms-3 col-sm-5 col-8">  
</div>
<div class="d-flex flex-row mt-3">
    <p>Visit way : </p>
...
<p>Report : </p>
<textarea class="col-10" style="height: 200px;" name="report"></textarea>
</section>
 <!-- Display errors -->
 @if ($errors->any())
