...
<div class="px-5">
    ...
    <div class="d-flex flex-row mt-5">
        ...
        <form class="input-group mb-2 h-50 w-25" role="searprimarych" type="get" action="{{route('search.coordinator.company',['user_id' => $user->id])}}">
            <input class="form-control border-gray" name="search" type="search" placeholder="Search" aria-label="Search"
            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Search by the companies' name">
        ...
        <table class="table table-hover" >
            ...
            <tbody class="bg-light">
                ...
                <tr class="company-row">
                    <td class="ps-3">
                    <a class="link-dark link-underline-opacity-0 fw-bold" href="{{route('coordinator_company_profile',
